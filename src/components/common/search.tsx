...
import { useGetDragAndGenericSearchResultQuery } from '../../features/search/searchApi';
...
const Search = React.forwardRef<HTMLDivElement, Props>(
  (
    ...
    const { data, isLoading } = useGetDragAndGenericSearchResultQuery({
                  ...
                  {isLoading
                    ...
                    : data?.map((item: any, index: any) => (
                        <div
                          ...
                          className="ltr:pl-5 rtl:pr-5 ltr:pr-10 rtl:pl-10 scroll-snap-align-start transition-colors duration-200 hover:bg-fill-base"
                          onClick={clear}
                        >
