...
import { useGetGenericBySubCategoryIdQuery } from 'src/features/dragClass/dragClassApi';
...
function CategoryGeneric() {
    ...
    const { data, isLoading, isSuccess, isError } = useGetGenericBySubCategoryIdQuery(id);
