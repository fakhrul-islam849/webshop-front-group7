...
import FilterSidebar from '@components/doctor/filter-sidebar';
  ...
  return (
    <div className="flex items-center justify-between mb-6">
      ...
      <div className="flex items-center justify-end w-full lg:justify-between">
        <div className="shrink-0 text-brand-dark font-medium text-15px leading-4 md:ltr:mr-6 md:rtl:ml-6 hidden lg:block mt-0.5"></div>
        {/* <ListBox
          options={[
