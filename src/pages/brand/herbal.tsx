...
import { useGetBrandListHerbalQuery } from '../../features/brand/brandApi';
...
export default function Herbal() {
  ...
  const { data, isLoading, isSuccess, isError } = useGetBrandListHerbalQuery({
    page: pageNumber,
  ...
  return (
    <>
      <Seo title="Brand List" description="Herbal Brand List" path="classic" />
