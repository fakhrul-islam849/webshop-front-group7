...
import { useGetBrandListFoodSupplymentQuery } from '../../features/brand/brandApi';
...
export default function FoodSupplyment() {
    ...
    const { data, isLoading, isSuccess, isError } = useGetBrandListFoodSupplymentQuery({
        page: pageNumber,
    ...
    return (
        <>
            <PageSeo
                title="All Brand List Food Supplyment"
