...
import { useGetGenericListQuery } from '../../features/generic/genericApi';
...
import GenericCard from '@components/card/generic-card';
...
export default function Allopathic() {
  ...
  const { data, isLoading, isSuccess, isError } = useGetGenericListQuery({
    page: pageNumber,
  ...
  return (
    <>
      <PageSeo
          title="All Generic List Allopathic"
