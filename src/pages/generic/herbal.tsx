...
import { useGetGenericListHerbalQuery } from '../../features/generic/genericApi';
...
export default function Allopathic() {
  ...
  const { data, isLoading, isSuccess, isError } = useGetGenericListHerbalQuery({
    page: pageNumber,
