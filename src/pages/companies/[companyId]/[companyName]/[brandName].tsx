...
import { useGetBrandListByCompanyIdQuery } from '../../../../features/brand/brandApi';
...
export default function Allopathic() {
  const {
    query: { companyName, companyId, brandName },
  } = useRouter();
